...
def build_layout(
    ...
    if snap:
        ...
        price_table.add_row("aggTrade Flow",f"{snap.flow_ratio:.1%} buy  "
    ...
    if ind and signal:
        ...
        sig_table.add_row("Converged",   Text("YES", style="green") if signal.converged else Text("NO", style="red"))
        ...
        sig_table.add_row("Mark Lag",    Text(f"{signal.mark_price_lag:.3f}", style="yellow" if signal.mark_price_lag > 0.003 else "dim"))
